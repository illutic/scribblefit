...
- `/spec [feature]` -- Generate a technical feature specification
- `/build [feature]` -- Implement a feature spec layer-by-layer
- `/retrospect [feature]` -- Analyze implementation and update guidelines
